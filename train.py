...
with tf.Session() as sess:
    ...
    for epoch in range(opts.epochs):
        ...
        for step in range(batches_per_epoch):
            ...
            _, summary, cur_train_loss = sess.run([train_op, merged, train_loss], feed_dict={model.inputs: img_batches})
        ...
        imageio.imwrite('eval/epoch_{}.jpg'.format(epoch + 1), output_img)
